...
component = Hooks.component \_ _ -> Hooks.pure $
  ...
  [ HH.img [css "rounded-full mx-auto block", HP.src "./images/yuki_icon1.png", HP.width 80, HP.height 80]
  , HH.p [css "block text-2xl my-2.5 font-bold"] [HH.text "ゆきくらげ / Yukikurage"]
  , HH.div [css "max-w-4xl min-w-min mx-auto pt-3 flex flex-wrap justify-around"]
...
mkAbout title description =
  HH.div [css "my-1.5 w-96 h-auto text-center"]
