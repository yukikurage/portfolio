              ...
              return function (nowPlayingId) {
                  ...
                  return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(new Data_Either.Left("\u66f2\u60c5\u5831\u3092\u53d6\u5f97\u3057\u3066\u3044\u307e\u3059")))(function (v) {
                      return Halogen_Hooks_Hook.discard(Halogen_Hooks.useLifecycleEffect(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Control_Bind.bindFlipped(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.put(v.value1))(Control_Monad_Trans_Class.lift(Halogen_Hooks_HookM.monadTransHookM)(dictMonad)(YukiPortfolio_Classes_MusicHandler.getMusics(dictMusicHandler))))(function () {
                          ...
                          return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("musics") ])(Data_Either.either((function () {
                              var $8 = YukiPortfolio_Parts_ErrorMessage.errorMessage("\u66f2\u60c5\u5831\u304c\u53d6\u5f97\u3067\u304d\u307e\u305b\u3093\u3067\u3057\u305f");
                              return function ($9) {
                                  return Data_Array.singleton($8($9));
                              };
                          })())((function () {
                              var $10 = Data_Functor.map(Data_Functor.functorArray)(function (music) {
