...
(function($PS) {
  ...
  var notFound = YukiPortfolio_Components_HTML_ErrorMessage.errorMessage("\u30da\u30fc\u30b8\u304c\u898b\u3064\u304b\u308a\u307e\u305b\u3093\u3067\u3057\u305f")("\x0a( ^-^)_\u65e6\"\"");
  exports["notFound"] = notFound;
})(PS);
(function(exports) {
  "use strict";
                      ...
                      return Halogen_Hooks_Hook.bind(YukiPortfolio_Hooks_UseHash.useHash(dictMonadEffect))(function (nowPage) {
                          return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div([ YukiPortfolio_Components_Common.css("bodyRoot") ])([ Halogen_HTML_Elements.div([ YukiPortfolio_Components_Common.css("static") ])([ Halogen_HTML_Elements.div([ YukiPortfolio_Components_Common.css("header") ])([ YukiPortfolio_Components_HTML_TitleBar.titleBar, YukiPortfolio_Components_HTML_NavigationBar.navigationBar([ YukiPortfolio_Data_Pages.About.value, YukiPortfolio_Data_Pages.Musics.value, YukiPortfolio_Data_Pages.Pictures.value, YukiPortfolio_Data_Pages.WebApps.value ])(nowPage) ]), YukiPortfolio_Components_HTML_MusicPlayer.musicPlayer(v2.value0) ]), Halogen_HTML_Elements.div([ YukiPortfolio_Components_Common.css("dynamic") ])([ Halogen_HTML_Elements.div([ YukiPortfolio_Components_Common.css("main") ])([ (function () {
                              ...
                              if (nowPage instanceof YukiPortfolio_Data_Pages.About) {
                                  return YukiPortfolio_Components_Pages_About.about;
                              };
                              ...
                              if (nowPage instanceof YukiPortfolio_Data_Pages.NotFound) {
                                  return YukiPortfolio_Components_Pages_NotFound.notFound;
                              };
                              throw new Error("Failed pattern match at YukiPortfolio.Components.Body (line 43, column 11 - line 49, column 33): " + [ nowPage.constructor.name ]);
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](CSS_Selector.star)(CSS_Selector.byClass("icon")))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.maxHeight(CSS_Size.pct(70.0)))(function () {
                                      ...
                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](CSS_Selector.star)(CSS_Selector.byClass("yukikurage")))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.maxHeight(CSS_Size.pct(100.0)))(function () {
                                          ...
                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](CSS_Selector.star)(CSS_Selector.byClass("socialIconLink")))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.Display(CSS_Property.value(CSS_Property.valString)("contents"))))(function () {
                                              ...
                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](CSS_Selector.star)(CSS_Selector.byClass("socialIcon")))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.px(80.0)))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.color(Color.white))(function () {
