                  ...
                  return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(YukiPortfolio_Data_MusicPlayerState.NotPlaying.value))(function (v2) {
                      return Halogen_Hooks_Hook.bind(YukiPortfolio_Hooks_UseHash.useHash(dictMonadEffect))(function (nowPage) {
                          return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div([ YukiPortfolio_Components_Common.css("bodyRoot") ])([ Halogen_HTML_Elements.div([ YukiPortfolio_Components_Common.css("static") ])([ Halogen_HTML_Elements.div([ YukiPortfolio_Components_Common.css("header") ])([ YukiPortfolio_Components_HTML_TitleBar.titleBar, YukiPortfolio_Components_HTML_NavigationBar.navigationBar([ YukiPortfolio_Data_Pages.About.value, YukiPortfolio_Data_Pages.Musics.value, YukiPortfolio_Data_Pages.Pictures.value, YukiPortfolio_Data_Pages.WebApps.value ])(nowPage) ]), YukiPortfolio_Components_HTML_MusicPlayer.musicPlayer(v2.value0) ]), Halogen_HTML_Elements.div([ YukiPortfolio_Components_Common.css("dynamic") ])([ Halogen_HTML_Elements.div([ YukiPortfolio_Components_Common.css("main") ])([ (function () {
                              ...
                              throw new Error("Failed pattern match at YukiPortfolio.Components.Body (line 44, column 11 - line 50, column 33): " + [ nowPage.constructor.name ]);
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.pct(100.0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.maxHeight(CSS_Size.pct(100.0)))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Cursor.cursor(CSS_Cursor.pointer))(function () {
                                  return CSS_Transition.transitionDuration("0.3s");
                              });
                          });
                      });
                  }));
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.paddingLeft(CSS_Size.px(20.0)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.fontFamily([ "Montserrat" ])(Data_NonEmpty.singleton(Control_Plus.plusArray)(CSS_Font.sansSerif)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Flexbox.justifyContent(CSS_Flexbox.flexStart(CSS_Flexbox.flexStartJustifyContentValue)))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.a)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.marginRight(CSS_Size.px(24.0)))(function () {
...
(function($PS) {
  ...
  var main = Effect_Aff.launchAff_(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitLoad)(function () {
      return Control_Bind.bind(Effect_Aff.bindAff)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Effect_Aff.applicativeAff)(YukiPortfolio_App.runApp(Effect_Aff.monadAff))(YukiPortfolio_Styles_StyleSheet.components))(function (styleSheet) {
          return Control_Bind.bind(Effect_Aff.bindAff)(YukiPortfolio_App.runApp(Effect_Aff.monadAff)(YukiPortfolio_Components_Body.component(YukiPortfolio_App.musicHandlerApp)(YukiPortfolio_App.monadEffectApp)))(function (body) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.selectElement("head"))(function (headElem) {
                  return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.selectElement("body"))(function (bodyElem) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Data_Foldable.traverse_(Effect_Aff.applicativeAff)(Data_Foldable.foldableMaybe)(function (elem) {
                          return Data_Foldable.traverse_(Effect_Aff.applicativeAff)(Data_Foldable.foldableArray)(function (component) {
                              return Halogen_VDom_Driver.runUI(component)(Data_Unit.unit)(elem);
                          })(styleSheet);
                      })(headElem))(function () {
