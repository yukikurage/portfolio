...
(function($PS) {
  ...
  var yukiGreyYellow = function (op) {
      return Color.rgba(245)(241)(231)(op);
  };
  var yukiBlack = Color.rgb(50)(50)(50);
  ...
  var musicPageStyle = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](CSS_Selector.star)(CSS_Selector.byClass("musics")))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(fadeIn("musics"))(function () {
          ...
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](CSS_Selector.star)(CSS_Selector.byClass("musicPanelInner")))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.paddingLeft(CSS_Size.px(6.0)))(function () {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.query(CSS_Media.screen)(Data_NonEmpty.singleton(Control_Plus.plusArray)(CSS_Media.maxWidth(CSS_Size.px(1000.0))))(CSS_Stylesheet.select(CSS_Selector["with"](CSS_Selector.star)(CSS_Selector.byClass("musicPanel")))(CSS_Geometry.width(CSS_Size.pct(100.0 / 3.0)))))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.query(CSS_Media.screen)(Data_NonEmpty.singleton(Control_Plus.plusArray)(CSS_Media.maxWidth(CSS_Size.px(750.0))))(CSS_Stylesheet.select(CSS_Selector["with"](CSS_Selector.star)(CSS_Selector.byClass("musicPanel")))(CSS_Geometry.width(CSS_Size.pct(100.0 / 2.0)))))(function () {
                      return CSS_Stylesheet.query(CSS_Media.screen)(Data_NonEmpty.singleton(Control_Plus.plusArray)(CSS_Media.maxWidth(CSS_Size.px(500.0))))(CSS_Stylesheet.select(CSS_Selector["with"](CSS_Selector.star)(CSS_Selector.byClass("musicPanel")))(CSS_Geometry.width(CSS_Size.pct(100.0))));
                  });
              });
          });
      });
  });
  var errorMessageStyle = CSS_Stylesheet.select(CSS_Selector["with"](CSS_Selector.star)(CSS_Selector.byClass("errorMessage")))(CSS_TextAlign.textAlign(CSS_TextAlign.center));
  var aboutPageStyle = CSS_Stylesheet.select(CSS_Selector["with"](CSS_Selector.star)(CSS_Selector.byClass("about")))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(fadeIn("about"))(function () {
  ...
  var style = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(errorMessageStyle)(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(aboutPageStyle)(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(musicPageStyle)(function () {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.left(CSS_Size.px(0.0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.pct(100.0)))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.px(120.0)))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Border.border(CSS_Border.solid)(CSS_Size.px(0.0))(yukiBlack))(function () {
