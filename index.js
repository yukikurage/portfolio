  ...
  var musicPanel = function (dictMonadEffect) {
      return function (v) {
          return function (nowPlayingId) {
              ...
              }) ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src(v.thumbnail) ]), Halogen_HTML_Elements.h4_([ Halogen_HTML_Core.text(v.title) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(v.description) ]) ]) ]);
          };
      };
  };
  ...
  var style = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](CSS_Selector.star)(CSS_Selector.byClass("musicPanels")))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.maxWidth(CSS_Size.px(1000.0)))(function () {
      ...
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](CSS_Selector.star)(CSS_Selector.byClass("musicPanel")))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.pct(100.0 / 4.0)))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_TextAlign.textAlign(CSS_TextAlign.center))(function () {
              return CSS_Stylesheet.select(CSS_Elements.img)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Common.auto(CSS_Size.autoSize)))(function () {
