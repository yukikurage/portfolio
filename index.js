...
(function($PS) {
  ...
  var titleBar = Halogen_HTML_Elements.div([ YukiPortfolio_Components_Common.css("titleBar") ])([ Halogen_HTML_Elements.div([ YukiPortfolio_Components_Common.css("content") ])([ Halogen_HTML_Elements.img([ YukiPortfolio_Components_Common.css("icon"), Halogen_HTML_Properties.src("./public/images/icon512_white.png") ]), Halogen_HTML_Elements.div([ YukiPortfolio_Components_Common.css("yukikurage") ])([ Halogen_HTML_Core.text("KURAGE WORKS") ]), socialIcon("fab fa-twitter")("https://twitter.com/yukikurage_2019"), socialIcon("fab fa-soundcloud")("https://soundcloud.com/yukikurage"), socialIcon("fab fa-youtube")("https://www.youtube.com/channel/UCTGwIwjCRMpe7cmpP2EaH3w"), socialIcon("fab fa-github")("https://github.com/yukikurage") ]) ]);
  ...
  var component = Halogen_Hooks_Component.component(function (tokens) {
      return function (input) {
          return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(false))(function (v) {
              return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div([ YukiPortfolio_Components_Common.css("musicPanel") ])([ Halogen_HTML_Elements.div([ YukiPortfolio_Components_Common.css("musicPanelInner"), Halogen_HTML_Events.onClick(function (v1) {
                  return Halogen_Hooks_HookM.raise(tokens.outputToken)(Play.value);
              }) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("imgWrapper") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src(input.music.thumbnail), Halogen_HTML_Properties.width(200), Halogen_HTML_Properties.height(200), Halogen_HTML_Events.onLoad(function (v1) {
                  return Halogen_Hooks_HookM.put(v.value1)(true);
              }), Halogen_HTML_Properties.style((function () {
                  if (v.value0) {
                      return "opacity:1";
                  };
                  return "opacity:0";
...
(function($PS) {
  ...
  var _page = Type_Proxy["Proxy"].value;
  var component = function (dictMusicHandler) {
      return function (dictMonadEffect) {
          return Halogen_Hooks_Component.component(function (v) {
              return function (v1) {
                  return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(YukiPortfolio_Data_MusicPlayerState.NotPlaying.value))(function (v2) {
                      return Halogen_Hooks_Hook.bind(YukiPortfolio_Hooks_UseHash.useHash(dictMonadEffect))(function (nowPage) {
                          return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div([ YukiPortfolio_Components_Common.css("bodyRoot") ])([ Halogen_HTML_Elements.div([ YukiPortfolio_Components_Common.css("static") ])([ Halogen_HTML_Elements.div([ YukiPortfolio_Components_Common.css("header") ])([ YukiPortfolio_Components_HTML_TitleBar.titleBar, YukiPortfolio_Components_HTML_NavigationBar.navigationBar([ YukiPortfolio_Data_Pages.About.value, YukiPortfolio_Data_Pages.Musics.value, YukiPortfolio_Data_Pages.Pictures.value, YukiPortfolio_Data_Pages.WebApps.value ])(nowPage) ]), YukiPortfolio_Components_HTML_MusicPlayer.musicPlayer(v2.value0) ]), Halogen_HTML_Elements.div([ YukiPortfolio_Components_Common.css("dynamic") ])([ Halogen_HTML_Elements.div([ YukiPortfolio_Components_Common.css("main") ])([ (function () {
                              if (nowPage instanceof YukiPortfolio_Data_Pages.Musics) {
                                  return Halogen_HTML.slot()({
                                      reflectSymbol: function () {
                                          return "page";
                                      }
                                  })(Data_Ord.ordString)(_page)("Musics")(YukiPortfolio_Components_Pages_Musics.component(dictMonadEffect.Monad0())(dictMusicHandler))(Data_Unit.unit)(function (v3) {
                                      return Halogen_Hooks_HookM.put(v2.value1)(new YukiPortfolio_Data_MusicPlayerState.Playing(v3.value0));
                                  });
                              };
                              if (nowPage instanceof YukiPortfolio_Data_Pages.About) {
                                  ...
                                  })(Data_Ord.ordString)(_page)("About")(YukiPortfolio_Components_Pages_About.component)(Data_Unit.unit);
                              };
                              ...
                              if (nowPage instanceof YukiPortfolio_Data_Pages.NotFound) {
                                  ...
                                  })(Data_Ord.ordString)(_page)("NotFound")(YukiPortfolio_Components_Pages_NotFound.component)(Data_Unit.unit);
                              };
                              throw new Error("Failed pattern match at YukiPortfolio.Components.Body (line 43, column 11 - line 49, column 74): " + [ nowPage.constructor.name ]);
...
(function($PS) {
  ...
  var fadeIn = function (id) {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.keyframesFromTo("fadeIn" + id)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.relative))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.top(CSS_Size.px(-5.0)))(function () {
              return CSS_Display.opacity(0.0);
          });
      }))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.relative))(function () {
...
(function($PS) {
  ...
  var style = CSS_Stylesheet.select(CSS_Selector["with"](CSS_Selector.star)(CSS_Selector.byClass("about")))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(YukiPortfolio_Styles_Common.fadeIn("about"))(function () {
...
(function($PS) {
  ...
  var Control_Bind = $PS["Control.Bind"];
  var YukiPortfolio_Styles_Common = $PS["YukiPortfolio.Styles.Common"];                
  var style = CSS_Stylesheet.select(CSS_Selector["with"](CSS_Selector.star)(CSS_Selector.byClass("musicPlayer")))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.fixed))(function () {
          ...
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.query(CSS_Media.screen)(Data_NonEmpty.singleton(Control_Plus.plusArray)(CSS_Media.maxWidth(CSS_Size.px(1000.0))))(CSS_Stylesheet.select(CSS_Selector["with"](CSS_Selector.star)(CSS_Selector.byClass("musicPanel")))(CSS_Geometry.width(CSS_Size.pct(100.0 / 3.0)))))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.query(CSS_Media.screen)(Data_NonEmpty.singleton(Control_Plus.plusArray)(CSS_Media.maxWidth(CSS_Size.px(750.0))))(CSS_Stylesheet.select(CSS_Selector["with"](CSS_Selector.star)(CSS_Selector.byClass("musicPanel")))(CSS_Geometry.width(CSS_Size.pct(100.0 / 2.0)))))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.query(CSS_Media.screen)(Data_NonEmpty.singleton(Control_Plus.plusArray)(CSS_Media.maxWidth(CSS_Size.px(500.0))))(CSS_Stylesheet.select(CSS_Selector["with"](CSS_Selector.star)(CSS_Selector.byClass("musicPanel")))(CSS_Geometry.width(CSS_Size.pct(100.0)))))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(YukiPortfolio_Styles_Common.fadeIn("musics"))(function () {
...
(function($PS) {
  ...
  var style = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](CSS_Selector.star)(CSS_Selector.byClass("titleBar")))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.pct(100.0)))(function () {
      ...
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](CSS_Selector.star)(CSS_Selector.byClass("titleBar::before")))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(YukiPortfolio_Styles_Common.yukiColors.black))(function () {
      ...
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(YukiPortfolio_Styles_AboutPage.style)(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(YukiPortfolio_Styles_MusicsPage.style)(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(YukiPortfolio_Styles_TitleBar.style)(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(YukiPortfolio_Styles_MusicPlayer.style)(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(YukiPortfolio_Styles_NavigationBar.style)(function () {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](CSS_Selector.star)(CSS_Selector.byClass("header")))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.fixed))(function () {
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](CSS_Selector.star)(CSS_Selector.byClass("static")))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.fixed))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.left(CSS_Size.px(0.0)))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.top(CSS_Size.px(0.0)))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.pct(100.0)))(function () {
                                                  return CSS_Display.zIndex(100);
                                              });
                                          });
                                      });
                                  })))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](CSS_Selector.star)(CSS_Selector.byClass("dynamic")))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.zIndex(50))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.absolute))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.top(CSS_Size.px(0.0)))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.left(CSS_Size.px(0.0)))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.right(CSS_Size.px(0.0)))(function () {
                                          ...
                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](CSS_Selector.star)(CSS_Selector.byClass("main")))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.paddingTop(CSS_Size.px(130.0)))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Flexbox.flexGrow(1.0))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.paddingBottom(CSS_Size.px(130.0)))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.paddingLeft(CSS_Size.px(15.0)))(function () {
                                                          return CSS_Geometry.paddingRight(CSS_Size.px(15.0));
                                                      });
                                                  });
                                              });
                                          })))(function () {
