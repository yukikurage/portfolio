  ...
  var component = Halogen_Hooks_Component.component(function (tokens) {
      return function (input) {
          return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(false))(function (v) {
              return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("musicPanel") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("musicPanelInner"), Halogen_HTML_Events.onClick(function (v1) {
              ...
              return function (v1) {
                  return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(YukiPortfolio_Data_MusicPlayerState.NotPlaying.value))(function (v2) {
                      return Halogen_Hooks_Hook.bind(YukiPortfolio_Hooks_UseHash.useHash(dictMonadEffect))(function (nowPage) {
                          return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("bodyRoot") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("static") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("header") ])([ YukiPortfolio_Components_HTML_TitleBar.titleBar, YukiPortfolio_Components_HTML_NavigationBar.navigationBar([ YukiPortfolio_Data_Pages.About.value, YukiPortfolio_Data_Pages.Musics.value, YukiPortfolio_Data_Pages.Pictures.value, YukiPortfolio_Data_Pages.WebApps.value ])(nowPage) ]), YukiPortfolio_Components_HTML_MusicPlayer.musicPlayer(v2.value0) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("dynamic") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("main") ])([ (function () {
