...
(function($PS) {
  "use strict";
  $PS["YukiPortfolio.Components.Root"] = $PS["YukiPortfolio.Components.Root"] || {};
  var exports = $PS["YukiPortfolio.Components.Root"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Data_Unit = $PS["Data.Unit"];
  var Halogen_Component = $PS["Halogen.Component"];
...
(function($PS) {
  ...
  var YukiPortfolio_Components_Root = $PS["YukiPortfolio.Components.Root"];                
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(YukiPortfolio_Components_Root.component)(Data_Unit.unit)(body);
  }));
  exports["main"] = main;
})(PS);
PS["Main"].main();