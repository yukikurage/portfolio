...
(function($PS) {
  ...
  var fadeIn = function (id) {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.keyframesFromTo("fadeIn" + id)(CSS_Display.opacity(0.0))(CSS_Display.opacity(1.0)))(function () {
