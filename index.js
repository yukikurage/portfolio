...
(function($PS) {
  "use strict";
  $PS["YukiPortfolio.Pages"] = $PS["YukiPortfolio.Pages"] || {};
  var exports = $PS["YukiPortfolio.Pages"];
  var About = (function () {
      function About() {
  ...
  var showPage = function (v) {
      ...
      throw new Error("Failed pattern match at YukiPortfolio.Pages (line 15, column 12 - line 20, column 25): " + [ v.constructor.name ]);
  };
  var pageToHash = function (v) {
      ...
      throw new Error("Failed pattern match at YukiPortfolio.Pages (line 24, column 14 - line 29, column 25): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  ...
  var YukiPortfolio_Pages = $PS["YukiPortfolio.Pages"];                
  var navigationBar = function (pages) {
      return function (nowPage) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Web_HTML_Common.ClassName("navigationBar")) ])(Data_Functor.map(Data_Functor.functorArray)(function (page) {
              return Halogen_HTML_Elements.a(Data_Array.catMaybes([ Data_Maybe.Just.create(Halogen_HTML_Properties.href("#" + YukiPortfolio_Pages.pageToHash(page))), (function () {
                  var $0 = Data_Eq.eq(YukiPortfolio_Pages.eqPages)(nowPage)(page);
                  if ($0) {
                      return Data_Maybe.Just.create(Halogen_HTML_Properties.class_("nowPage"));
                  };
                  return Data_Maybe.Nothing.value;
              })() ]))([ Halogen_HTML_Core.text(YukiPortfolio_Pages.showPage(page)) ]);
          })(pages));
      };
  };
              ...
              return Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(dictMonadEffect))(Web_HTML.window))(function (window) {
                  return Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.subscribe(Halogen_Query_Event.eventListener("hashchange")(Web_HTML_Window.toEventTarget(window))(function (v) {
                      return new Data_Maybe.Just(Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(dictMonadEffect))(Routing_Hash.getHash))(function (hash) {
                          return setPage(YukiPortfolio_Pages.hashToPage(hash));
                      }));
                      ...
                      return Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(dictMonadEffect))(Routing_Hash.getHash))(function (hash) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(setPage(YukiPortfolio_Pages.hashToPage(hash)))(function () {
          ...
          return Halogen_Hooks_Component.component(function (v) {
              return function (v1) {
                  return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(YukiPortfolio_Types_MusicPlayerState.NotPlaying.value))(function (v2) {
                      return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(YukiPortfolio_Pages.NotFound.value))(function (v3) {
                          return Halogen_Hooks_Hook.bind(YukiPortfolio_Pages_Musics.useMusicsPage(dictMonadEffect.Monad0())(dictMusicHandler)(dictMonadEffect)(v2.value1))(function (musicsPage) {
                              return Halogen_Hooks_Hook.discard(Halogen_Hooks.useLifecycleEffect(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Control_Bind.bindFlipped(Halogen_Hooks_HookM.bindHookM)((function () {
                                  ...
                                  return function ($15) {
                                      return $14(YukiPortfolio_Pages.hashToPage($15));
                                  };
                                  ...
                                  return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("bodyRoot") ])([ YukiPortfolio_Parts_NavigationBar.navigationBar([ YukiPortfolio_Pages.About.value, YukiPortfolio_Pages.Musics.value, YukiPortfolio_Pages.Pictures.value, YukiPortfolio_Pages.WebApps.value ])(v3.value0), (function () {
                                      var $9 = Data_Eq.eq(YukiPortfolio_Pages.eqPages)(v3.value0)(YukiPortfolio_Pages.Musics.value);
                                      if ($9) {
                                          return musicsPage;
                                      };
                                      return Halogen_HTML_Elements.div_([  ]);
