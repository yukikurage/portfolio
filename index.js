...
(function($PS) {
  ...
  var musicHandlerApp = {
      getMusics: Control_Applicative.pure(applicativeApp)(YukiPortfolio_Data_Musics.musics),
      Monad0: function () {
          return monadApp;
      }
  };
                              ...
                              return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("musics") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.mapWithIndex(function (i) {
                                  return function (v2) {
                                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("musicPanel") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("musicPanelInner"), Halogen_HTML_Events.onClick(function (v3) {
                                          return Halogen_Hooks_HookM.put(nowPlayingId)(YukiPortfolio_Types_MusicPlayerState.Playing.create(v2));
...
(function($PS) {
  ...
  var pageToHash = function (v) {
      ...
      throw new Error("Failed pattern match at YukiPortfolio.Types.Pages (line 23, column 14 - line 28, column 25): " + [ v.constructor.name ]);
  };
                          ...
                          return Halogen_Hooks_Hook.bind(YukiPortfolio_Pages_Musics.useMusicsPage(dictMonadEffect.Monad0())(dictMusicHandler)(dictMonadEffect)(v2.value1))(function (musicsPage) {
                              return Halogen_Hooks_Hook.discard(Halogen_Hooks.useLifecycleEffect(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Control_Bind.bindFlipped(Halogen_Hooks_HookM.bindHookM)((function () {
                                  ...
                                  return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("bodyRoot") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("static") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("header") ])([ YukiPortfolio_Parts_TitleBar.titleBar, YukiPortfolio_Parts_NavigationBar.navigationBar([ YukiPortfolio_Types_Pages.About.value, YukiPortfolio_Types_Pages.Musics.value, YukiPortfolio_Types_Pages.Pictures.value, YukiPortfolio_Types_Pages.WebApps.value ])(v3.value0) ]), YukiPortfolio_Parts_MusicPlayer.musicPlayer(v2.value0) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("dynamic") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("main") ])([ (function () {
                                      ...
                                      if (v3.value0 instanceof YukiPortfolio_Types_Pages.About) {
                                          return YukiPortfolio_Pages_About.about;
                                      };
                                      if (v3.value0 instanceof YukiPortfolio_Types_Pages.Pictures) {
                                          return Halogen_HTML_Elements.div_([  ]);
                                      };
                                      if (v3.value0 instanceof YukiPortfolio_Types_Pages.WebApps) {
                                          return Halogen_HTML_Elements.div_([  ]);
                                      };
                                      if (v3.value0 instanceof YukiPortfolio_Types_Pages.NotFound) {
                                          return YukiPortfolio_Pages_NotFound.notFound;
                                      };
                                      throw new Error("Failed pattern match at YukiPortfolio.Components.Body (line 54, column 11 - line 59, column 33): " + [ v3.value0.constructor.name ]);
