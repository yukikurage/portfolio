...
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["YukiPortfolio.Documents.Musics"] = $PS["YukiPortfolio.Documents.Musics"] || {};
  var exports = $PS["YukiPortfolio.Documents.Musics"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Maybe = $PS["Data.Maybe"];
...
(function($PS) {
  ...
  var Effect_Aff = $PS["Effect.Aff"];
  var Safe_Coerce = $PS["Safe.Coerce"];
  var YukiPortfolio_Documents_Musics = $PS["YukiPortfolio.Documents.Musics"];
  var monadEffectApp = Effect_Aff.monadEffectAff;
  var monadApp = Effect_Aff.monadAff;
  var applicativeApp = Effect_Aff.applicativeAff;
  var musicHandlerApp = {
      getMusics: Control_Applicative.pure(applicativeApp)(YukiPortfolio_Documents_Musics.musics),
      Monad0: function () {
          return monadApp;
      }
  };
...
(function($PS) {
  ...
  var musicPlayer = function (musicPlayerState) {
      if (musicPlayerState instanceof YukiPortfolio_Data_MusicPlayerState.Playing) {
          ...
          throw new Error("Failed pattern match at YukiPortfolio.Components.HTML.MusicPlayer (line 16, column 28 - line 23, column 26): " + [ musicPlayerState.value0.soundTrackId.constructor.name ]);
      };
      if (musicPlayerState instanceof YukiPortfolio_Data_MusicPlayerState.NotPlaying) {
          return Halogen_HTML_Elements.div_([  ]);
      };
      throw new Error("Failed pattern match at YukiPortfolio.Components.HTML.MusicPlayer (line 15, column 32 - line 24, column 27): " + [ musicPlayerState.constructor.name ]);
  };
  ...
  var navigationBar = function (pages) {
      return function (nowPage) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Web_HTML_Common.ClassName("navigationBar")) ])(Data_Functor.map(Data_Functor.functorArray)(function (page) {
              return Halogen_HTML_Elements.a(Data_Array.catMaybes([ Data_Maybe.Just.create(Halogen_HTML_Properties.href("#" + YukiPortfolio_Data_Pages.pageToHash(page))), (function () {
                  var $0 = Data_Eq.eq(YukiPortfolio_Data_Pages.eqPages)(nowPage)(page);
                  if ($0) {
...
(function($PS) {
  ...
  var socialIcon = function (str) {
      return function (link) {
          return Halogen_HTML_Elements.a([ Halogen_HTML_Properties.class_("socialIconLink"), Halogen_HTML_Properties.href(link), Halogen_HTML_Properties.target("_blank"), Halogen_HTML_Properties.rel("noopener") ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_(Web_HTML_Common.ClassName("socialIcon " + str)) ])([  ]) ]);
      };
  };
  var titleBar = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("titleBar") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("content") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.class_("icon"), Halogen_HTML_Properties.src("./public/images/icon512_white.png") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("yukikurage") ])([ Halogen_HTML_Core.text("YUKI WORKS") ]), socialIcon("fab fa-twitter")("https://twitter.com/yukikurage_2019"), socialIcon("fab fa-soundcloud")("https://soundcloud.com/yukikurage"), socialIcon("fab fa-youtube")("https://www.youtube.com/channel/UCTGwIwjCRMpe7cmpP2EaH3w") ]) ]);
  exports["titleBar"] = titleBar;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["YukiPortfolio.Pages.About"] = $PS["YukiPortfolio.Pages.About"] || {};
  var exports = $PS["YukiPortfolio.Pages.About"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var Halogen_HTML_Properties = $PS["Halogen.HTML.Properties"];                
      ...
      return function (dictMusicHandler) {
          return function (dictMonadEffect) {
              return function (nowPlayingId) {
                  ...
                  return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState([  ]))(function (v) {
                      return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState([  ]))(function (v1) {
                          return Halogen_Hooks_Hook.discard(Halogen_Hooks.useLifecycleEffect(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Control_Bind.bindFlipped(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.put(v.value1))(Control_Monad_Trans_Class.lift(Halogen_Hooks_HookM.monadTransHookM)(dictMonad)(YukiPortfolio_Classes_MusicHandler.getMusics(dictMusicHandler))))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Control_Bind.bindFlipped(Halogen_Hooks_HookM.bindHookM)((function () {
                                  var $17 = Halogen_Hooks_HookM.put(v1.value1);
                                  var $18 = Data_Functor.map(Data_Functor.functorArray)(function (v2) {
                                      return false;
                                  });
                                  return function ($19) {
                                      return $17($18($19));
                                  };
                              })())(Control_Monad_Trans_Class.lift(Halogen_Hooks_HookM.monadTransHookM)(dictMonad)(YukiPortfolio_Classes_MusicHandler.getMusics(dictMusicHandler))))(function () {
                                  return Control_Applicative.pure(Halogen_Hooks_HookM.applicativeHookM)(Data_Maybe.Nothing.value);
                              });
                          })))(function () {
                              return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("musics") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.mapWithIndex(function (i) {
                                  return function (v2) {
                                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("musicPanel") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("musicPanelInner"), Halogen_HTML_Events.onClick(function (v3) {
                                          return Halogen_Hooks_HookM.put(nowPlayingId)(YukiPortfolio_Data_MusicPlayerState.Playing.create(v2));
                                      }) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("imgWrapper") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src(v2.thumbnail), Halogen_HTML_Properties.width(200), Halogen_HTML_Properties.height(200), Halogen_HTML_Events.onLoad(function (v3) {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Control_Monad_Trans_Class.lift(Halogen_Hooks_HookM.monadTransHookM)(dictMonad)(Effect_Class_Console.log(dictMonadEffect)("loaded")))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Control_Monad_Trans_Class.lift(Halogen_Hooks_HookM.monadTransHookM)(dictMonad)(Effect_Class_Console.logShow(dictMonadEffect)(Data_Show.showArray(Data_Show.showBoolean))(v1.value0)))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.modify_(v1.value1)(function (xs) {
                                                      return Data_Maybe.fromMaybe(xs)(Data_Array.updateAt(i)(true)(xs));
                                                  }))(function () {
                                                      return Control_Monad_Trans_Class.lift(Halogen_Hooks_HookM.monadTransHookM)(dictMonad)(Effect_Class_Console.logShow(dictMonadEffect)(Data_Show.showArray(Data_Show.showBoolean))(v1.value0));
                                                  });
                                              });
                                          });
                                      }), Halogen_HTML_Properties.style((function () {
                                          var $12 = Data_Maybe.fromMaybe(false)(Data_Array.index(v1.value0)(i));
                                          if ($12) {
                                              return "opacity:1";
                                          };
                                          return "opacity:0";
                                      })()) ]) ]), Halogen_HTML_Elements.h4_([ Halogen_HTML_Core.text(v2.title) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(v2.description) ]) ]) ]);
                                  };
                              })(v.value0))(dummies)));
                          });
                      });
...
(function($PS) {
  ...
  var errorMessage = function (title) {
      return function (description) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("errorMessage") ])([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text(title) ]), Halogen_HTML_Core.text(description) ]);
      };
  };
...
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["YukiPortfolio.Pages.NotFound"] = $PS["YukiPortfolio.Pages.NotFound"] || {};
  var exports = $PS["YukiPortfolio.Pages.NotFound"];
          ...
          return Halogen_Hooks_Component.component(function (v) {
              return function (v1) {
                  return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(YukiPortfolio_Data_MusicPlayerState.NotPlaying.value))(function (v2) {
                      return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(YukiPortfolio_Data_Pages.NotFound.value))(function (v3) {
                          return Halogen_Hooks_Hook.bind(YukiPortfolio_Pages_Musics.useMusicsPage(dictMonadEffect.Monad0())(dictMusicHandler)(dictMonadEffect)(v2.value1))(function (musicsPage) {
                              return Halogen_Hooks_Hook.discard(Halogen_Hooks.useLifecycleEffect(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Control_Bind.bindFlipped(Halogen_Hooks_HookM.bindHookM)((function () {
                                  ...
                                  return function ($15) {
                                      return $14(YukiPortfolio_Data_Pages.hashToPage($15));
                                  };
                              })())(Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(dictMonadEffect))(Routing_Hash.getHash)))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Control_Bind.bindFlipped(Halogen_Hooks_HookM.bindHookM)(Effect_Class_Console.log(Halogen_Hooks_HookM.monadEffectHookM(dictMonadEffect)))(Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(dictMonadEffect))(Routing_Hash.getHash)))(function () {
                                  ...
                                  return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("bodyRoot") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("static") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("header") ])([ YukiPortfolio_Components_HTML_TitleBar.titleBar, YukiPortfolio_Components_HTML_NavigationBar.navigationBar([ YukiPortfolio_Data_Pages.About.value, YukiPortfolio_Data_Pages.Musics.value, YukiPortfolio_Data_Pages.Pictures.value, YukiPortfolio_Data_Pages.WebApps.value ])(v3.value0) ]), YukiPortfolio_Components_HTML_MusicPlayer.musicPlayer(v2.value0) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("dynamic") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("main") ])([ (function () {
                                      if (v3.value0 instanceof YukiPortfolio_Data_Pages.Musics) {
                                          return musicsPage;
                                      };
                                      if (v3.value0 instanceof YukiPortfolio_Data_Pages.About) {
                                          return YukiPortfolio_Pages_About.about;
                                      };
                                      if (v3.value0 instanceof YukiPortfolio_Data_Pages.Pictures) {
                                          return Halogen_HTML_Elements.div_([  ]);
                                      };
                                      if (v3.value0 instanceof YukiPortfolio_Data_Pages.WebApps) {
                                          return Halogen_HTML_Elements.div_([  ]);
                                      };
                                      if (v3.value0 instanceof YukiPortfolio_Data_Pages.NotFound) {
                                          return YukiPortfolio_Pages_NotFound.notFound;
                                      };
                                      throw new Error("Failed pattern match at YukiPortfolio.Components.Body (line 56, column 11 - line 61, column 33): " + [ v3.value0.constructor.name ]);
                                  })() ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("footer") ])([ YukiPortfolio_Components_HTML_Copyright.copyright ]) ]) ]));
                              });
                          });
                      });
                  });
...
(function($PS) {
  ...
  var main = Effect_Aff.launchAff_(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitLoad)(function () {
      return Control_Bind.bind(Effect_Aff.bindAff)(YukiPortfolio_App.runApp(Effect_Aff.monadAff)(YukiPortfolio_Styles_StyleSheet.component))(function (styleSheet) {
